...
namespace Dominion.GCVision
{
    #region image annotate API
        ...
        {
            public string gcsImageUri, imageUri;
        }

        [Serializable]
        public class LatLongRect
        {
            public LatLng minLatLng, maxLatLng;
        }
    ...
    #region response model
        ...
        {
            public string name, displayName, description, productCategory;
        ...
        {
            public string mid, languageCode, name;
            public double score;
            public BoundingPoly boundingPoly;
        }
        ...
        {
            public BoundingPoly boundingPoly, fdBoundingPoly;
            public Landmark[] landmarks;
            public double rollAngle, panAngle, tiltAngle, detectionConfidence, landmarkingConfidence;
            public GCVisionEnumerators.Likelihood joyLikelihood, sorrowLikelihood, angerLikelihood, surpriseLikelihood, underExposedLikelihood, blurredLikelihood, headwearLikelihood;
        }
        ...
        {
            public string mid, locale, description;
            public double score, confidence, topicality;
            public BoundingPoly boundingPoly;
        ...
        {
            public string adult, spoof, medical, violence, racy;
        }
        ...
        {
            public BoundingPoly boundingPoly;
            public double confidence, importanceFraction;
        }
        ...
        public class WebDetection
        {
            ...
            public WebImage[] fullMatchingImages, partialMatchingImages, visuallySimilarImages;
        ...
        {
            public string entityId, description;
            public double score;
        }
        ...
        public class WebPage
        {
            ...
            public double score;
            public WebImage[] fullMatchingImages, partialMatchingImages;
        }

        [Serializable]
        public class WebLabel
        {
            public string label, languageCode;
        }
